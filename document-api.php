...
<head>
    <meta charset="utf-8" />
    <title>ICONIC YOU | Document API</title>
    <!-- Meta -->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    <div class="app-wrapper">
        ...
        <!-- Main Content -->
        <main class="app-main">
            <!-- ใช้ iframe ในการดึงหน้าเว็บ https://iconicyou-api.pointit.co.th/docs มาแสดงภายในหน้า monitoring.php -->
            <iframe src="https://iconicyou-api.pointit.co.th/docs"
